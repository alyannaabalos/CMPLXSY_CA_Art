; Elementary Cellular Automata - Rule 99
...
to setup
  ...
  ask patch 0 max-pycor [ set pcolor green ]  ;; create initial yellow cell in the top center
  reset-ticks
end
...
to do-rule  ;; patch procedure
  ...
  ifelse ((left-pcolor = green and center-pcolor = green and right-pcolor = green) or  ;; evaluate rule 90
          (left-pcolor = green and center-pcolor = white and right-pcolor = white) or
          (left-pcolor = white and center-pcolor = green and right-pcolor = green) or
          (left-pcolor = white and center-pcolor = green and right-pcolor = white))
