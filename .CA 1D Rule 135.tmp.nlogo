; Elementary Cellular Automata - Rule 135
...
to setup
  ...
  ask patch 0 max-pycor [ set pcolor b ]  ;; create initial blue cell in the top center of the world
  reset-ticks
end
...
to do-rule  ;; patch procedure
  ...
  ifelse ((left-pcolor = blue and center-pcolor = blue and right-pcolor = blue) or  ;; evaluate rule 30
          ...
          (left-pcolor = white and center-pcolor = white and right-pcolor = blue) or
          (left-pcolor = white and center-pcolor = white and right-pcolor = white))
