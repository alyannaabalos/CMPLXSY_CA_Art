...
to setup
  ...
  ask patch 0 max-pycor [ set pcolor red ]  ;; create initial blue cell in the top center of the world
  reset-ticks
end
...
to do-rule  ;; patch procedure
  ...
  ifelse ((left-pcolor = red and center-pcolor = red and right-pcolor = red) or  ;; evaluate rule 30
          (left-pcolor = white and center-pcolor = red and right-pcolor = white) or
          (left-pcolor = white and center-pcolor = white and right-pcolor = red) or
