; Elementary Cellular Automata - Rule 150
; Modified code (originally Rule 90)
...
to setup
  ...
  ask patch 0 max-pycor [ set pcolor blue ]  ;; create initial blue cell in the top center of the world
  reset-ticks
end
...
;; set the state of the patch below by applying rule 150
to do-rule  ;; patch procedure
  ...
  ifelse ((left-pcolor = blue and center-pcolor = blue and right-pcolor = blue) or  ;; evaluate rule 30
          (left-pcolor = blue and center-pcolor = white and right-pcolor = white) or
          (left-pcolor = white and center-pcolor = blue and right-pcolor = white) or
          (left-pcolor = white and center-pcolor = white and right-pcolor = blue))
...
Rule 150 is one of the eight additive elementary cellular automata (Wolfram 2002, p. 952).
...
For example, if we have a Rule 150 CA, and the current cell is black and its left neighbor is yellow and its right neighbor is yellow, the cell below it is painted black.
...
Weisstein, Eric W. "Rule 150." From MathWorld--A Wolfram Web Resource. https://mathworld.wolfram.com/Rule150.html
@#$#@#$#@
default
true
0
